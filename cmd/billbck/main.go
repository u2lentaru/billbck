...
import (
	...
	_ "github.com/u2lentaru/billbck/internal/docs"
...
func main() {
	...
	route.HandleFunc("/form_types", pgs.handleFormTypes).Methods("GET", "OPTIONS")
	route.HandleFunc("/form_types_add", pgs.handleAddFormType).Methods("POST", "OPTIONS")
	route.HandleFunc("/form_types_upd", pgs.handleUpdFormType).Methods("POST", "OPTIONS")
	route.HandleFunc("/form_types_del", pgs.handleDelFormType).Methods("POST", "OPTIONS")
	route.HandleFunc("/form_types/{id:[0-9]+}", pgs.handleGetFormType).Methods("GET", "OPTIONS")
	route.PathPrefix("/swagger/").Handler(httpSwagger.WrapHandler).Methods("GET", "OPTIONS")
	route.HandleFunc("/sub_types", pgs.handleSubTypes).Methods("GET", "OPTIONS")
	route.HandleFunc("/sub_types_add", pgs.handleAddSubType).Methods("POST", "OPTIONS")
	route.HandleFunc("/sub_types_upd", pgs.handleUpdSubType).Methods("POST", "OPTIONS")
	route.HandleFunc("/sub_types_del", pgs.handleDelSubType).Methods("POST", "OPTIONS")
	route.HandleFunc("/sub_types/{id:[0-9]+}", pgs.handleGetSubType).Methods("GET", "OPTIONS")
