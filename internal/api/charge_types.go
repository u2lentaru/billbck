...
type ifChargeTypeService interface {
...
func HandleChargeTypes(w http.ResponseWriter, r *http.Request) {
	var gs ifChargeTypeService
	gs = services.NewChargeTypeService(pgsql.ChargeTypeStorage{})
...
func HandleAddChargeType(w http.ResponseWriter, r *http.Request) {
	var gs ifChargeTypeService
	gs = services.NewChargeTypeService(pgsql.ChargeTypeStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifChargeTypeService.Add: ", err)
	}
...
func HandleUpdChargeType(w http.ResponseWriter, r *http.Request) {
	var gs ifChargeTypeService
	gs = services.NewChargeTypeService(pgsql.ChargeTypeStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifChargeTypeService.Upd: ", err)
	}
...
func HandleDelChargeType(w http.ResponseWriter, r *http.Request) {
	var gs ifChargeTypeService
	gs = services.NewChargeTypeService(pgsql.ChargeTypeStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifChargeTypeService.Del: ", err)
	}
...
func HandleGetChargeType(w http.ResponseWriter, r *http.Request) {
	var gs ifChargeTypeService
	gs = services.NewChargeTypeService(pgsql.ChargeTypeStorage{})
	ctx := context.Background()
	auth := utils.GetAuth(r)
	...
	if err != nil {
		log.Println("Failed execute ifChargeTypeService.GetOne: ", err)
	}
