...
type ifSealStatusService interface {
...
func HandleSealStatuses(w http.ResponseWriter, r *http.Request) {
	var gs ifSealStatusService
	gs = services.NewSealStatusService(pgsql.SealStatusStorage{})
...
func HandleAddSealStatus(w http.ResponseWriter, r *http.Request) {
	var gs ifSealStatusService
	gs = services.NewSealStatusService(pgsql.SealStatusStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifSealStatusService.Add: ", err)
	}
...
func HandleUpdSealStatus(w http.ResponseWriter, r *http.Request) {
	var gs ifSealStatusService
	gs = services.NewSealStatusService(pgsql.SealStatusStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifSealStatusService.Upd: ", err)
	}
...
func HandleDelSealStatus(w http.ResponseWriter, r *http.Request) {
	var gs ifSealStatusService
	gs = services.NewSealStatusService(pgsql.SealStatusStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifSealStatusService.Del: ", err)
	}
...
func HandleGetSealStatus(w http.ResponseWriter, r *http.Request) {
	var gs ifSealStatusService
	gs = services.NewSealStatusService(pgsql.SealStatusStorage{})
	ctx := context.Background()
	auth := utils.GetAuth(r)
	...
	if err != nil {
		log.Println("Failed execute ifSealStatusService.GetOne: ", err)
	}
