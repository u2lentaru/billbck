...
type ifSealTypeService interface {
...
func HandleSealTypes(w http.ResponseWriter, r *http.Request) {
	var gs ifSealTypeService
	gs = services.NewSealTypeService(pgsql.SealTypeStorage{})
...
func HandleAddSealType(w http.ResponseWriter, r *http.Request) {
	var gs ifSealTypeService
	gs = services.NewSealTypeService(pgsql.SealTypeStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifSealTypeService.Add: ", err)
	}
...
func HandleUpdSealType(w http.ResponseWriter, r *http.Request) {
	var gs ifSealTypeService
	gs = services.NewSealTypeService(pgsql.SealTypeStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifSealTypeService.Upd: ", err)
	}
...
func HandleDelSealType(w http.ResponseWriter, r *http.Request) {
	var gs ifSealTypeService
	gs = services.NewSealTypeService(pgsql.SealTypeStorage{})
	ctx := context.Background()
	...
	if err != nil {
		log.Println("Failed execute ifSealTypeService.Del: ", err)
	}
...
func HandleGetSealType(w http.ResponseWriter, r *http.Request) {
	var gs ifSealTypeService
	gs = services.NewSealTypeService(pgsql.SealTypeStorage{})
	ctx := context.Background()
	auth := utils.GetAuth(r)
	...
	if err != nil {
		log.Println("Failed execute ifSealTypeService.GetOne: ", err)
	}
