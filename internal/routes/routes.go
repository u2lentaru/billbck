...
func AddRoutes(r *mux.Router, apg *api.APG) {
	...
	r.HandleFunc("/uzo", api.HandleUzo).Methods("GET", "OPTIONS")
	r.HandleFunc("/uzo_add", api.HandleAddUzo).Methods("POST", "OPTIONS")
	r.HandleFunc("/uzo_upd", api.HandleUpdUzo).Methods("POST", "OPTIONS")
	r.HandleFunc("/uzo_del", api.HandleDelUzo).Methods("POST", "OPTIONS")
	r.HandleFunc("/uzo/{id:[0-9]+}", api.HandleGetUzo).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/puvalues", api.HandlePuValues).Methods("GET", "OPTIONS")
	r.HandleFunc("/puvalues_add", api.HandleAddPuValue).Methods("POST", "OPTIONS")
	r.HandleFunc("/puvalues_upd", api.HandleUpdPuValue).Methods("POST", "OPTIONS")
	r.HandleFunc("/puvalues_del", api.HandleDelPuValue).Methods("POST", "OPTIONS")
	r.HandleFunc("/puvalues/{id:[0-9]+}", api.HandleGetPuValue).Methods("GET", "OPTIONS")
	r.HandleFunc("/puvalues_askue_prev", api.HandlePuValuesAskuePreview).Methods("POST", "OPTIONS")
	r.HandleFunc("/puvalues_askue", api.HandlePuValuesAskue).Methods("POST", "OPTIONS")
	r.HandleFunc("/balance", api.HandleBalance).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance/{id:[0-9]+}/{tid:[0-9]+}", api.HandleGetBalance).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance_sum", api.HandleBalanceSum).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance_sum1", api.HandleBalanceSum1).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance_sum0", api.HandleBalanceSum0).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance_tab1", api.HandleBalanceTab1).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance_tab0", api.HandleBalanceTab0).Methods("GET", "OPTIONS")
	r.HandleFunc("/balance_branch", api.HandleBalanceBranch).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/violations", api.HandleViolations).Methods("GET", "OPTIONS")
	r.HandleFunc("/violations_add", api.HandleAddViolation).Methods("POST", "OPTIONS")
	r.HandleFunc("/violations_upd", api.HandleUpdViolation).Methods("POST", "OPTIONS")
	r.HandleFunc("/violations_del", api.HandleDelViolation).Methods("POST", "OPTIONS")
	r.HandleFunc("/violations/{id:[0-9]+}", api.HandleGetViolation).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/users", api.HandleUsers).Methods("GET", "OPTIONS")
	r.HandleFunc("/users_add", api.HandleAddUser).Methods("POST", "OPTIONS")
	r.HandleFunc("/users_upd", api.HandleUpdUser).Methods("POST", "OPTIONS")
	r.HandleFunc("/users_del", api.HandleDelUser).Methods("POST", "OPTIONS")
	r.HandleFunc("/users/{id:[0-9]+}", api.HandleGetUser).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/transtypes", api.HandleTransTypes).Methods("GET", "OPTIONS")
	r.HandleFunc("/transtypes_add", api.HandleAddTransType).Methods("POST", "OPTIONS")
	r.HandleFunc("/transtypes_upd", api.HandleUpdTransType).Methods("POST", "OPTIONS")
	r.HandleFunc("/transtypes_del", api.HandleDelTransType).Methods("POST", "OPTIONS")
	r.HandleFunc("/transtypes/{id:[0-9]+}", api.HandleGetTransType).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/transvolt", api.HandleTransVolt).Methods("GET", "OPTIONS")
	r.HandleFunc("/transvolt_add", api.HandleAddTransVolt).Methods("POST", "OPTIONS")
	r.HandleFunc("/transvolt_upd", api.HandleUpdTransVolt).Methods("POST", "OPTIONS")
	r.HandleFunc("/transvolt_del", api.HandleDelTransVolt).Methods("POST", "OPTIONS")
	r.HandleFunc("/transvolt/{id:[0-9]+}", api.HandleGetTransVolt).Methods("GET", "OPTIONS")
	...
	r.HandleFunc("/transpwr", api.HandleTransPwr).Methods("GET", "OPTIONS")
	r.HandleFunc("/transpwr_add", api.HandleAddTransPwr).Methods("POST", "OPTIONS")
	r.HandleFunc("/transpwr_upd", api.HandleUpdTransPwr).Methods("POST", "OPTIONS")
	r.HandleFunc("/transpwr_del", api.HandleDelTransPwr).Methods("POST", "OPTIONS")
	r.HandleFunc("/transpwr/{id:[0-9]+}", api.HandleGetTransPwr).Methods("GET", "OPTIONS")
